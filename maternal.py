...
fetal_model = pickle.load(open('C:/Users/KIIT/Desktop/Maternal Health/fetal_health_classifier.sav','rb'))
maternal_model = pickle.load(open('C:/Users/KIIT/Desktop/Maternal Health/finalized_maternal_model.sav','rb'))
...
with st.sidebar:
    ...
    st.write("Choose an option from menu below to get started")
...
if (selected == 'About us'):
    ...
    with col1:
        ...
        st.image("C:/Users/KIIT/Desktop/Maternal Health/pregnancy_risk_image.jpg", caption="Pregnancy Risk Prediction", use_container_width=True)
    with col2:
        ...
        st.image("C:/Users/KIIT/Desktop/Maternal Health/fetal_health_image.jpg", caption="Fetal Health Prediction", use_container_width=True)
...
if (selected == 'Pregnancy Risk Prediction'):
    ...
    with col2:
        #reset predictions value for next predictions 
        if st.button("Clear"): 
            st.rerun()
...
if (selected == 'Fetal Health Prediction'):
    ...
    st.markdown(f"<div style='white-space: pre-wrap;'><b>{content}</b></div></br>", unsafe_allow_html=True)
    st.write("Please provide only decimal values ")
    # getting the input data from the user
    col1, col2, col3 = st.columns(3)
